// Temporarily simplified Events component for performance testing
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-400">Temporarily simplified for performance testing</p>
        <p className="text-sm text-gray-500 mt-4">
          Performance optimizations are active in background components
        </p>
      </div>
    </div>
  );
    ...
    <>
      <div className="min-h-screen bg-[#020617] text-white overflow-x-hidden pt-24 pb-12">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-center gap-12">
          {/* Event Selection - Show wheel on desktop, grid on mobile */}
          <div className="flex flex-col items-center justify-center">
            ...
            {/* Desktop: Event Wheel, Mobile: Event Grid */}
            {!isMobile ? (
              <EventWheel
                events={events}
